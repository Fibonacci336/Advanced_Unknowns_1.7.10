...
import com.fibonacci.advanced_unknowns.block.Wire;
...
public class AU_Blocks {
    ...
    public static void loadBlocks(){
        ...
        wire = new Wire(Material.wood).setBlockName("Wire").setBlockTextureName("advancedunknowns:Wire").setCreativeTab(Advanced_Unknowns.tab);
    }
